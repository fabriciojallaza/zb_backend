...
* Swager UI: http://127.0.0.1:8000/v1/docs/
* Redoc: http://127.0.0.1:8000/v1/redoc/
...
3. Copy the token and go back to the API [Docs](http://ec2-3-93-152-219.compute-1.amazonaws.com:8000/v1/docs/)
...
### API Docs Online
* Swagger UI : [Swagger](http://ec2-3-93-152-219.compute-1.amazonaws.com:8000/v1/docs/)
* Redoc : [Redoc](http://ec2-3-93-152-219.compute-1.amazonaws.com:8000/v1/redoc/)
